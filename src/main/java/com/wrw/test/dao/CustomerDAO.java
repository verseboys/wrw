...
import com.wrw.test.pojo.Customer;
 ...
 * 
 * @see com.wrw.test.pojo.Customer
...
public class CustomerDAO {
	...
	public Customer findById(java.lang.Integer id) {
		...
		try {
			Customer instance = (Customer) getCurrentSession().get("com.wrw.test.pojo.Customer", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.wrw.test.pojo.Customer")
	...
	public List findByCustPhone(Object custPhone) {
		return findByProperty(CUST_PHONE, custPhone);
	}
	...
	public Customer merge(Customer detachedInstance) {
		...
		try {
			Customer result = (Customer) getCurrentSession().merge(detachedInstance);
