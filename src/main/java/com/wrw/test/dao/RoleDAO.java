...
public class RoleDAO {
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) getCurrentSession().get("com.wrw.test.pojo.Role", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Role instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.wrw.test.pojo.Role").add(Example.create(instance))
					.list();
